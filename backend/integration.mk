...
req-articles-post:
	curl -v -XPOST -H "Authorization: Bearer $(shell cat ./$(TOKEN_FILE))" $(HOST):$(PORT)/articles -d '{"article":{"title": "$(ARTICLE_TITLE)", "body": "$(ARTICLE_BODY)"},"tags":[1,2],"jiro":2}'

req-articles-post-light:
